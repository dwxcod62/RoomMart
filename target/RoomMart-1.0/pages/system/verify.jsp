...
<head>
    ...
    <title>Room Mart - Xác thực </title>
                        ...
                        <form action="check-otp" method="POST" id="verify-form" class="custom-form verify-form">
                            ...
                            <div class="form-header">
                                ...
                                <div class="form-subtitle">
                                    <span>*</span> Một mã xác nhận đã được gửi đến email của bạn!
                                    Vui lòng điền vào ô
                                    dưới để xác thực tài khoản!
                                </div>
                            </div>
    ...
    <script>
        ...
        const handleSendOtp = () => {
            ...
            axios.get('http://localhost:8080/RoomMart/send-otp', {
                params: {
