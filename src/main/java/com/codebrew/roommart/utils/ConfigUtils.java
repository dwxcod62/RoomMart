...
public class ConfigUtils {
    ...
    public static String vnp_Returnurl = "http://mammal-casual-boar.ngrok-free.app/RoomMart/confirm-payment-status";
    ...
    public static String hashAllFields(Map fields) {
        ...
        return hmacSHA512(ConfigUtils.vnp_HashSecret, sb.toString());
    }
