...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
    ...
    <style>
        ...
        /* Example styles for better appearance */
...
<!-- Show chat button -->
<button class="show-chat-button" onclick="toggleChatBox()"><i style=" font-size: 30px;" class="bi bi-chat-right-text"></i></button>

<%--<button style="top: 0px;left: 0px" class="close-button" onclick="closeBoxChat()">Close</button>--%>




        <div id="chatContainer" class="layout" style="display: none">
...
<%--                        &lt;%&ndash;                <a id="link-room-detail" class="nav-link position-relative p-0 py-xl-3" href="roomDetail?hostelId=${encodedHostelId}&rid=${encodedRoomId}" title="Back" >&ndash;%&gt;--%>
<%--                        &lt;%&ndash;                    <i class="icon-lg fe-chevron-left"></i>&ndash;%&gt;--%>
...
<%--                        </a>--%>
<%--                        &lt;%&ndash;                <a href="javascript:history.back()" class="btn btn-warning"> <i class="fas fa-arrow-left"></i> Go Back</a>&ndash;%&gt;--%>
<%--                    </li>--%>
<%--                    <!-- Chats -->--%>
<%--                    <li class="nav-item mt-xl-9">--%>
            ...
            <div class="main main-visible" data-mobile-height="">
                ...
                <div id="chat-1" class="chat dropzone-form-js" data-dz-url="some.php">
                    ...
                    <div class="chat-body">
                        ...
                        <!-- Chat: Header -->
                        <div style="background-color: cornflowerblue"  class="chat-header border-bottom py-4 py-lg-6 px-lg-8">
                        ...
                        <!-- Chat: Footer -->
                        <div id="chat-footer"  class="chat-footer border-top py-4 py-lg-6 px-lg-8">
                            <div class="container-xxl">
...
<!-- Scripts -->
<script>
    var showChatButton = document.querySelector('.show-chat-button');
