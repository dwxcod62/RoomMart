<%@ page import="com.codebrew.roommart.dto.UserInformation" %>
...
<%--    <%   UserInformation ACC_INFO = (UserInformation) request.getAttribute("ACC_INFO");%>--%>
<%--%>--%>
<div>
    <!-- navbar -->
    <!-- content -->
