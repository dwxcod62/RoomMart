        ...
        <div class="row">
            <div class="col-12">
                <div class="copyright-wrapper d-flex justify-content-center">
                    <div class="copyright-content">© 2022 Room Mart. All rights reserved.</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-between">
                    <a href="home" class="btn btn-secondary">Để sau</a>
                    <a href="login-page"  class="btn btn-primary">Đăng nhập ngay</a>
                </div>
            </div>
        </div>
    </div>
