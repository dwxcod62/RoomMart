                ...
                <div class="content__body mb-5">
                    <div class="bill">
                        ...
                        <div class="bill__action">
                            ...
                            <a class="btn btn-secondary fs-4" href="down-bill?billID=${requestScope.billRoom.billID}&hostelID=${sessionScope.hostel.hostelID}&roomID=${sessionScope.room.roomId}">
                                Xuất Excel
                            </a>
