                ...
                <div class="col-12 col-md-8 col-lg-8 col-xl-7 col-xxl-8">
                    ...
                    <div class="tabs">
                        <div class="tabs-item active">
                            <i class="tabs-icon fa-solid fa-circle-exclamation"></i> Chưa duyệt
                        </div>
                        <div class="tabs-item active">
                            <i class="tabs-icon fa-solid fa-file-circle-check"></i> Đang duyệt
                        </div>
                        <div class="line"></div>
                    </div>
                </div>
                        ...
                        <table id="invoice-table-1" class="content__table table table-bordered table-striped">
                            <thead class="content__thead">
                                <tr>
                                    ...
                                    <th class="text-center">Người đăng kí</th>
                            ...
                            <tbody class="content__tbody">
                                <c:forEach var="list" items="${requestScope.LIST_CONTRACT}" varStatus="loop">
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ${AccountDao.getAccountById(list.getRenterId()).username}
                                        </td>
                                        <td class="text-center">
                ...
                <div class="content__item active">
                    ...
                    <div class="filter__wrapper">
                        <table>
                            ...
                            <tr>
                                <td><i class="fa-solid fa-sliders"></i> Lọc</td>
                                <form id="form-no-payment-bill1">
                                    <td>
                                        <select name="hostelId" id="filter__hostel-select-11">
                                            <option value="">Tất cả</option>
                                            <c:forEach var="hostel" items="${requestScope.LIST_HOSTELS}">
                                                <option value="${hostel.hostelID}">${hostel.hostelName}</option>
                                            </c:forEach>
                                    ...
                                    <td>
                                        <select name="roomId" id="filter__room-select-11" disabled>
                                            <option value="">Tất cả</option>
                                        </select>
                                    </td>
                                </form>
                    ...
                    <!-- Infor box -->
                    <div id="content__body-11" class="content__body mb-5">
                        <table id="invoice-table-11" class="content__table table table-bordered table-striped">
                            <thead class="content__thead">
                            <tr>
                                <th class="text-center">Mã</th>
                                <th class="text-center">Khu trọ</th>
                            ...
                            <tbody class="content__tbody">
                            <c:forEach var="list" items="${requestScope.LIST_CONTRACT_GOING}" varStatus="loop">
                                <tr>
                                    <td class="text-center">
                                        <a href="ViewContractServlet?id=${list.getContract_id()}">#CT${list.getContract_id()}</a>
                                    </td>
