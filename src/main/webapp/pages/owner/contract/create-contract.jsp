        ...
        <div class="row position-relative">
            ...
            <div class="col-12 col-lg-9 col-xl-9 col-xxl-10 content-group">
                <div class="content-history">
                    ...
                    <i class="fa-solid fa-chevron-right"></i>
                    <a href="ownerRoomDetail?roomID=${sessionScope.room.roomId}&hostelID=${sessionScope.hostel.hostelID}" class="history-link">Phòng ${sessionScope.room.roomNumber}</a>
                    <i class="fa-solid fa-chevron-right"></i>
                    <div class="current">Tạo hợp đồng</div>
                </div>
                <div class="row mb-5">
                    <div class="content-body col-12 col-md-10 col-lg-9 col-xl-7 col-xxl-6 m-auto">
                        <form action="create-contract" method="post" class="custom-form create-room-account-form"
