                ...
                <div class="row my-5">
                    <div class="content-body col-12 col-md-10 col-lg-9 col-xl-7 col-xxl-6 m-auto">
                        <form action="createContract" method="post" class="custom-form create-room-account-form" id="create-room-account-form">
                            ...
                            <div>
                                <p><strong class="text-dark">Số phòng:</strong> <span class="text-muted">101</span></p>
                                <p><strong class="text-dark">Địa chỉ:</strong> <span class="text-muted">123 Trần Phú, Đà Nẵng</span></p>
                            </div>
