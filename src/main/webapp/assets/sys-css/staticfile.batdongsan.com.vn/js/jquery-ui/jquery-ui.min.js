...
(function(n) {
    ...
    var l, f, k, r, d, g, nt, tt, it, ut, t, et, ot, st, ht, ct, o, s, lt, at, vt, yt, pt, wt, bt, kt, dt, gt, ni, ti, ii, ri, ui, fi, ei, oi, si, hi, ci, li, ai, vi;
    n.ui = n.ui || {};
    n.extend(n.ui, {
        version: "1.11.4",
        keyCode: {
        ...
        _create: function() {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(t, i) {
                    ...
                    u = i.item.attr("aria-label") || r && r.value;
                    u && n.trim(u).length && (this.liveRegion.children().hide(), n("<div>").text(u).appendTo(this.liveRegion))
                },
