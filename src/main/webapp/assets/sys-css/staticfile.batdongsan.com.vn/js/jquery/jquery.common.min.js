...
(function(n, t) {
    ...
    function ti(n) {
        ...
        t === "input" ? ni(n) : t !== "script" && typeof n.getElementsByTagName != "undefined" && i.grep(n.getElementsByTagName("input"), ni)
    }

    function nu(n) {
        var t = r.createElement("div");
        return ht.appendChild(t), t.innerHTML = n.outerHTML, t.firstChild
    }
    ...
    function ii(n, t, r) {
        ...
        if (u = v(n, t), (u < 0 || u == null) && (u = n.style[t]), lt.test(u)) return u;
    ...
    function ri(n) {
        return function(t, r) {
            if (typeof t != "string" && (r = t, t = "*"), i.isFunction(r))
                for (var o = t.toLowerCase().split(yr), f = 0, h = o.length, u, s, e; f < h; f++) u = o[f], e = /^\+/.test(u), e && (u = u.substr(1) || "*"), s = n[u] = n[u] || [], s[e ? "unshift" : "push"](r)
        }
    }
    ...
    function k(n, i, r, u, f, e) {
        ...
        e = e || {};
        e[f] = !0;
        for (var s = n[f], h = 0, l = s ? s.length : 0, c = n === at, o; h < l && (c || !o); h++) o = s[h](i, r, u), typeof o == "string" && (!c || e[o] ? o = t : (i.dataTypes.unshift(o), o = k(n, i, r, u, o, e)));
        return !c && o || e["*"] || (o = k(n, i, r, u, "*", e)), o
    }
    ...
    function ft(n, t, r, u) {
        if (i.isArray(t)) i.each(t, function(t, i) {
            r || wf.test(n) ? u(n, i) : ft(n + "[" + (typeof i == "object" ? t : "") + "]", i, r, u)
        });
        else if (r || i.type(t) !== "object") u(n, t);
        else
            for (var f in t) ft(n + "[" + f + "]", t[f], r, u)
    }
    ...
    function ei() {
        return setTimeout(uu, 0), rt = i.now()
    }
    ...
    var r = n.document,
        ...
        hi = {},
        d, ci, li, ai, p, g, vi, a, yi, pi, et;
    i.Callbacks = function(n) {
        n = n ? hi[n] || dr(n) : {};
        var r = [],
            f = [],
            u, l, s, c, h, e, a = function(t) {
                for (var u, f, e = 0, s = t.length; e < s; e++) u = t[e], f = i.type(u), f === "array" ? a(u) : f === "function" && (n.unique && o.has(u) || r.push(u))
            },
            v = function(t, i) {
        ...
        data: function(n, r) {
            ...
            if (n === t) {
                if (this.length && (f = i.data(e), e.nodeType === 1 && !i._data(e, "parsedAttrs"))) {
                    for (h = e.attributes, l = h.length; c < l; c++) o = h[c].name, o.indexOf("data-") === 0 && (o = i.camelCase(o.substring(5)), yt(e, o, f[o]));
    ...
    i.extend({
        ...
        _unmark: function(n, t, r) {
            if (n !== !0 && (r = t, t = n, n = !1), t) {
                ...
                f ? i._data(t, u, f) : (i.removeData(t, u, !0), pt(t, r, "mark"))
            }
        },
    ...
    var wi = /[\n\t\r]/g,
        ...
        cu = /^a(?:rea)?$/i,
        bi = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,
    ...
    i.fn.extend({
        ...
        addClass: function(n) {
            ...
            if (n && typeof n == "string")
                for (r = n.split(nt), f = 0, o = this.length; f < o; f++)
        ...
        removeClass: function(n) {
            ...
            if (n && typeof n == "string" || n === t)
                for (o = (n || "").split(nt), u = 0, s = this.length; u < s; u++)
                    if (r = this[u], r.nodeType === 1 && r.className)
                        if (n) {
                            for (f = (" " + r.className + " ").replace(wi, " "), e = 0, h = o.length; e < h; e++) f = f.replace(" " + o[e] + " ", " ");
        ...
        toggleClass: function(n, t) {
            ...
            return i.isFunction(n) ? this.each(function(r) {
                ...
                if (r === "string")
                    for (var f, s = 0, o = i(this), e = t, h = n.split(nt); f = h[s++];) e = u ? e : !o.hasClass(f), o[e ? "addClass" : "removeClass"](f);
        ...
        hasClass: function(n) {
            for (var i = " " + n + " ", t = 0, r = this.length; t < r; t++)
                if (this[t].nodeType === 1 && (" " + this[t].className + " ").replace(wi, " ").indexOf(i) > -1) return !0;
            return !1
        },
        val: function(n) {
            var r, u, e, f = this[0];
            ...
            })) : f ? (r = i.valHooks[f.type] || i.valHooks[f.nodeName.toLowerCase()], r && "get" in r && (u = r.get(f, "value")) !== t) ? u : (u = f.value, typeof u == "string" ? u.replace(ou, "") : u == null ? "" : u) : void 0
        }
    });
    i.extend({
        valHooks: {
        ...
        attr: function(n, r, u, f) {
            ...
            if (n && c !== 3 && c !== 8 && c !== 2) {
                ...
                if (h = c !== 1 || !i.isXMLDoc(n), h && (r = r.toLowerCase(), s = i.attrHooks[r] || (bi.test(r) ? di : e)), u !== t) {
                    if (u === null) {
                        i.removeAttr(n, r);
                        return
                    }
        ...
        removeAttr: function(n, t) {
            var u, f, r, s, e, o = 0;
            if (t && n.nodeType === 1)
                for (f = t.toLowerCase().split(nt), s = f.length; o < s; o++) r = f[o], r && (u = i.propFix[r] || r, e = bi.test(r), e || i.attr(n, r, ""), n.removeAttribute(ki ? r : u), e && u in n && (n[u] = !1))
        },
        attrHooks: {
            type: {
                set: function(n, t) {
    ...
    ki || (gi = {
        ...
        get: function(n, i) {
            var r;
            return r = n.getAttributeNode(i), r && (gi[i] ? r.nodeValue !== "" : r.specified) ? r.nodeValue : t
        },
        set: function(n, t, i) {
    ...
    var ot = /^(?:textarea|input|select)$/i,
        nr = /^([^\.]*)?(?:\.(.+))?$/,
        lu = /(?:^|\s)hover(\.\S+)?\b/,
        au = /^key/,
        vu = /^(?:mouse|contextmenu)|click/,
        tr = /^(?:focusinfocus|focusoutblur)$/,
        yu = /^(\w*)(?:#([\w\-]+))?(?:\.([\w\-]+))?$/,
        pu = function(n) {
            var t = yu.exec(n);
    ...
    i.event = {
        add: function(n, r, u, f, e) {
            ...
            if (n.nodeType !== 3 && n.nodeType !== 8 && r && u && (a = i._data(n))) {
                for (u.handler && (w = u, u = w.handler, e = w.selector), u.guid || (u.guid = i.guid++), v = a.events, v || (a.events = v = {}), s = a.handle, s || (a.handle = s = function(n) {
                    ...
                    }, s.elem = n), r = i.trim(ir(r)).split(" "), y = 0; y < r.length; y++) p = nr.exec(r[y]) || [], o = p[1], b = (p[2] || "").split(".").sort(), h = i.event.special[o] || {}, o = (e ? h.delegateType : h.bindType) || o, h = i.event.special[o] || {}, l = i.extend({
                    type: o,
                    origType: p[1],
                    data: f,
                    handler: u,
        ...
        remove: function(n, t, r, u, f) {
            ...
            if (y && (v = y.events)) {
                for (t = i.trim(ir(t || "")).split(" "), l = 0; l < t.length; l++) {
                    if (p = nr.exec(t[l]) || [], e = b = p[1], h = p[2], !e) {
        ...
        trigger: function(r, u, f, e) {
            if (!f || f.nodeType !== 3 && f.nodeType !== 8) {
                var o = r.type || r,
                    p = [],
                    w, k, c, s, h, a, l, v, y, b;
                if (!tr.test(o + i.event.triggered) && (o.indexOf("!") >= 0 && (o = o.slice(0, -1), k = !0), o.indexOf(".") >= 0 && (p = o.split("."), o = p.shift(), p.sort()), f && !i.event.customEvent[o] || i.event.global[o])) {
                    ...
                    if (r.result = t, r.target || (r.target = f), u = u != null ? i.makeArray(u) : [], u.unshift(r), l = i.event.special[o] || {}, !l.trigger || l.trigger.apply(f, u) !== !1) {
                        if (y = [
                            ...
                            for (b = l.delegateType || o, s = tr.test(b + o) ? f : f.parentNode, h = null; s; s = s.parentNode) y.push([s, b]), h = s;
    ...
    i.Event = function(n, t) {
        ...
        n && n.type ? (this.originalEvent = n, this.type = n.type, this.isDefaultPrevented = n.defaultPrevented || n.returnValue === !1 || n.getPreventDefault && n.getPreventDefault() ? w : c) : this.type = n;
        t && i.extend(this, t);
    ...
    i.support.changeBubbles || (i.event.special.change = {
        setup: function() {
            if (ot.test(this.nodeName)) return (this.type === "checkbox" || this.type === "radio") && (i.event.add(this, "propertychange._change", function(n) {
            ...
            i.event.add(this, "beforeactivate._change", function(n) {
                var t = n.target;
                ot.test(t.nodeName) && !t._change_attached && (i.event.add(t, "change._change", function(n) {
        ...
        teardown: function() {
            return i.event.remove(this, "._change"), ot.test(this.nodeName)
        }
    });
    ...
    i.fn.extend({
        ...
        is: function(n) {
            return !!n && (typeof n == "string" ? rr.test(n) ? i(n, this.context).index(this[0]) >= 0 : i.filter(n, this).length > 0 : this.filter(n).length > 0)
        },
        closest: function(n, t) {
            ...
            for (o = rr.test(n) || typeof n != "string" ? i(n, t || this.context) : 0, u = 0, s = this.length; u < s; u++)
                for (r = this[u]; r;)
    ...
    var ur = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        st = /^\s+/,
        fr = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/ig,
        er = /<([\w:]+)/,
        uf = /<tbody/i,
        ff = /<|&#?\w+;/,
        ef = /<(?:script|style)/i,
        of = /<(?:script|object|embed|option|style)/i,
        or = new RegExp("<(?:" + ur + ")[\\s/>]", "i"),
        sr = /checked\s*(?:[^=]|=\s*.checked.)/i,
        hr = /\/(java|ecma)script/i,
        sf = /^\s*<!(?:\[CDATA\[|\-\-)/,
        u = {
    ...
    i.fn.extend({
        ...
        html: function(n) {
            return i.access(this, function(n) {
                ...
                if (typeof n == "string" && !ef.test(n) && (i.support.leadingWhitespace || !st.test(n)) && !u[(er.exec(n) || ["", ""])[1].toLowerCase()]) {
                    n = n.replace(fr, "<$1><\/$2>");
                    try {
        ...
        domManip: function(n, r, u) {
            var c, h, f, o, e = n[0],
                l = [];
            if (!i.support.checkClone && arguments.length === 3 && typeof e == "string" && sr.test(e)) return this.each(function() {
            ...
            if (this[0]) {
                if (o = e && e.parentNode, c = i.support.parentNode && o && o.nodeType === 11 && o.childNodes.length === this.length ? {
                    ...
                    r = r && i.nodeName(h, "tr");
                    for (var s = 0, a = this.length, v = a - 1; s < a; s++) u.call(r ? gr(this[s], h) : this[s], c.cacheable || a > 1 && s < v ? i.clone(f, !0, !0) : f)
                }
    ...
    i.buildFragment = function(n, t, u) {
        var e, h, s, o, f = n[0];
        return t && t[0] && (o = t[0].ownerDocument || t[0]), o.createDocumentFragment || (o = r), n.length === 1 && typeof f == "string" && f.length < 512 && o === r && f.charAt(0) === "<" && ! of .test(f) && (i.support.checkClone || !sr.test(f)) && (i.support.html5Clone || !or.test(f)) && (h = !0, s = i.fragments[f], s && s !== 1 && (e = s)), e || (e = o.createDocumentFragment(), i.clean(n, o, e, u)), h && (i.fragments[f] = s ? e : 1), {
            fragment: e,
            cacheable: h
        }
    };
    ...
    i.extend({
        clone: function(n, t, r) {
            var f, e, u, o = i.support.html5Clone || i.isXMLDoc(n) || !or.test("<" + n.nodeName + ">") ? n.cloneNode(!0) : nu(n);
            if ((!i.support.noCloneEvent || !i.support.noCloneChecked) && (n.nodeType === 1 || n.nodeType === 11) && !i.isXMLDoc(n))
                for (gt(n, o), f = b(n), e = b(o), u = 0; f[u]; ++u) e[u] && gt(f[u], e[u]);
            if (t && (dt(n, o), r))
                for (f = b(n), e = b(o), u = 0; f[u]; ++u) dt(f[u], e[u]);
            return f = e = null, o
        },
            ...
            for (t = t || r, typeof t.createElement == "undefined" && (t = t.ownerDocument || t[0] && t[0].ownerDocument || r), a = 0;
                ...
                if (typeof o == "number" && (o += ""), o) {
                    if (typeof o == "string")
                        if (ff.test(o)) {
                            o = o.replace(fr, "<$1><\/$2>");
                            var nt = (er.exec(o) || ["", ""])[1].toLowerCase(),
                                p = u[nt] || u._default,
                                tt = p[0],
                                s = t.createElement("div"),
                                b = ht.childNodes,
                                y;
                            for (t === r ? ht.appendChild(s) : kt(t).appendChild(s), s.innerHTML = p[1] + o + p[2]; tt--;) s = s.lastChild;
                            if (!i.support.tbody)
                                for (w = uf.test(o), v = nt === "table" && !w ? s.firstChild && s.firstChild.childNodes : p[1] === "<table>" && !w ? s.childNodes : [], c = v.length - 1; c >= 0; --c) i.nodeName(v[c], "tbody") && !v[c].childNodes.length && v[c].parentNode.removeChild(v[c]);
                            !i.support.leadingWhitespace && st.test(o) && s.insertBefore(t.createTextNode(st.exec(o)[0]), s.firstChild);
                            o = s.childNodes;
                            s && (s.parentNode.removeChild(s), b.length > 0 && (y = b[b.length - 1], y && y.parentNode && y.parentNode.removeChild(y)))
                        } else o = t.createTextNode(o);
                    if (!i.support.appendChecked)
                        if (o[0] && typeof(d = o.length) == "number")
                            for (c = 0; c < d; c++) ti(o[c]);
                        else ti(o);
                    o.nodeType ? l.push(o) : l = i.merge(l, o)
                }
            if (f)
                for (k = function(n) {
                        return !n.type || hr.test(n.type)
                    }, a = 0; l[a]; a++) h = l[a], e && i.nodeName(h, "script") && (!h.type || hr.test(h.type)) ? e.push(h.parentNode ? h.parentNode.removeChild(h) : h) : (h.nodeType === 1 && (g = i.grep(h.getElementsByTagName("script"), k), l.splice.apply(l, [a + 1, 0].concat(g))), f.appendChild(h));
            return l
        },
    ...
    i.extend({
        ...
        css: function(n, r, u) {
            var e, f;
            return (r = i.camelCase(r), f = i.cssHooks[r], r = i.cssProps[r] || r, r === "cssFloat" && (r = "float"), f && "get" in f && (e = f.get(n, !0, u)) !== t) ? e : v ? v(n, r) : void 0
        },
        swap: function(n, t, i) {
            var u = {},
                f;
    ...
    i.curCSS = i.css;
    r.defaultView && r.defaultView.getComputedStyle && (cr = function(n, t) {
        var r, e, u, o, f = n.style;
        return t = t.replace(cf, "-$1").toLowerCase(), (e = n.ownerDocument.defaultView) && (u = e.getComputedStyle(n, null)) && (r = u.getPropertyValue(t), r !== "" || i.contains(n.ownerDocument.documentElement, n) || (r = i.style(n, t))), !i.support.pixelMargin && u && vf.test(t) && lt.test(r) && (o = f.width, f.width = r, r = u.width, f.width = o), r
    });
    r.documentElement.currentStyle && (lr = function(n, t) {
        var f, u, e, i = n.currentStyle && n.currentStyle[t],
            r = n.style;
        return i == null && r && (e = r[t]) && (i = e), lt.test(i) && (f = r.left, u = n.runtimeStyle && n.runtimeStyle.left, u && (n.runtimeStyle.left = n.currentStyle.left), r.left = t === "fontSize" ? "1em" : i, i = r.pixelLeft + "px", r.left = f, u && (n.runtimeStyle.left = u)), i === "" ? "auto" : i
    });
    v = cr || lr;
    i.each(["height", "width"], function(n, t) {
        i.cssHooks[t] = {
            get: function(n, r, u) {
                if (r) return n.offsetWidth !== 0 ? ii(n, t, u) : i.swap(n, yf, function() {
                    return ii(n, t, u)
                })
            },
            set: function(n, t) {
    ...
    i.support.opacity || (i.cssHooks.opacity = {
        ...
        set: function(n, t) {
            ...
            (r.zoom = 1, t >= 1 && i.trim(f.replace(ct, "")) === "" && (r.removeAttribute("filter"), u && !u.filter)) || (r.filter = ct.test(f) ? f.replace(ct, e) : f + " " + e)
        }
    });
    i(function() {
        i.support.reliableMarginRight || (i.cssHooks.marginRight = {
            get: function(n, t) {
                return i.swap(n, {
                    ...
                    return t ? v(n, "margin-right") : n.style.marginRight
                })
            }
        })
    });
    ...
    h = pr.exec(s.toLowerCase()) || [];
    i.fn.extend({
        load: function(n, r, u) {
            var f, e, o, s;
            return typeof n != "string" && wr ? wr.apply(this, arguments) : this.length ? (f = n.indexOf(" "), f >= 0 && (e = n.slice(f, n.length), n = n.slice(0, f)), o = "GET", r && (i.isFunction(r) ? (u = r, r = t) : typeof r == "object" && (r = i.param(r, i.ajaxSettings.traditional), o = "POST")), s = this, i.ajax({
                url: n,
                type: o,
                dataType: "html",
                data: r,
        ...
        ajax: function(n, r) {
            function y(n, r, h, l) {
                if (e !== 2) {
                    ...
                    f.status = n;
                    f.statusText = "" + (r || a);
                    y ? nt.resolveWith(s, [b, a, f]) : nt.rejectWith(s, [f, a, w]);
                    f.statusCode(p);
                    p = t;
            ...
            if (nt.promise(f), f.success = f.done, f.error = f.fail, f.complete = rt.add, f.statusCode = function(n) {
                    ...
                    return this
                }, u.url = ((n || u.url) + "").replace(bf, "").replace(ne, h[1] + "//"), u.dataTypes = i.trim(u.dataType || "*").toLowerCase().split(yr), u.crossDomain == null && (l = pr.exec(u.url.toLowerCase()), u.crossDomain = !!(l && (l[1] != h[1] || l[2] != h[2] || (l[3] || (l[1] === "http:" ? 80 : 443)) != (h[3] || (h[1] === "http:" ? 80 : 443))))), u.data && u.processData && typeof u.data != "string" && (u.data = i.param(u.data, u.traditional)), k(at, u, r, f), e === 2) return !1;
            v = u.global;
            u.type = u.type.toUpperCase();
            u.hasContent = !gf.test(u.type);
            v && i.active++ == 0 && i.event.trigger("ajaxStart");
            u.hasContent || (u.data && (u.url += (vr.test(u.url) ? "&" : "?") + u.data, delete u.data), o = u.url, u.cache === !1 && (b = i.now(), d = u.url.replace(re, "$1_=" + b), u.url = d + (d === u.url ? (vr.test(u.url) ? "&" : "?") + "_=" + b : "")));
            ...
            f.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + (u.dataTypes[0] !== "*" ? ", " + kr + "; q=0.01" : "") : u.accepts["*"]);
        ...
        if (!r.crossDomain || i.support.cors) {
            ...
            return {
                send: function(f, e) {
                    ...
                    u = function(n, f) {
                        ...
                        try {
                            if (u && (f || o.readyState === 4))
                                if (u = t, h && (o.onreadystatechange = i.noop, g && delete a[h]), f) o.readyState !== 4 && o.abort();
                                else {
                                    s = o.status;
                    ...
                    r.async && o.readyState !== 4 ? (h = ++vi, g && (a || (a = {}, i(n).unload(g)), a[h] = u), o.onreadystatechange = u) : u()
                },
                abort: function() {
                    u && u(0, 1)
                }
    ...
    i.fn.extend({
        show: function(n, t, r) {
            var u, e, f, o;
            if (n || n === 0) return this.animate(l("show", 3), n, t, r);
            for (f = 0, o = this.length; f < o; f++) u = this[f], u.style && (e = u.style.display, i._data(u, "olddisplay") || e !== "none" || (e = u.style.display = ""), (e !== "" || i.css(u, "display") !== "none") && i.contains(u.ownerDocument.documentElement, u) || i._data(u, "olddisplay", oi(u.nodeName)));
            for (f = 0; f < o; f++) u = this[f], u.style && (e = u.style.display, (e === "" || e === "none") && (u.style.display = i._data(u, "olddisplay") || ""));
            return this
        },
        hide: function(n, t, r) {
            if (n || n === 0) return this.animate(l("hide", 3), n, t, r);
        ...
        animate: function(n, t, r, u) {
            function e() {
                ...
                for (r in n) {
                    ...
                    w && (r === "height" || r === "width") && (e.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY], i.css(this, "display") === "inline" && i.css(this, "float") === "none" && (i.support.inlineBlockNeedsLayout && oi(this.nodeName) !== "inline" ? this.style.zoom = 1 : this.style.display = "inline-block"))
                }
    ...
    pi = /^t(?:able|d|h)$/i;
    et = /^(?:body|html)$/i;
    yi = "getBoundingClientRect" in r.documentElement ? function(n, t, r, u) {
        try {
        ...
        for (var u, c = n.offsetParent, l = n, o = t.body, h = t.defaultView, s = h ? h.getComputedStyle(n, null) : n.currentStyle, f = n.offsetTop, e = n.offsetLeft;
            ...
            f -= n.scrollTop;
            e -= n.scrollLeft;
            n === c && (f += n.offsetTop, e += n.offsetLeft, !i.support.doesNotAddBorder || i.support.doesAddBorderForTableAndCells && pi.test(n.nodeName) || (f += parseFloat(u.borderTopWidth) || 0, e += parseFloat(u.borderLeftWidth) || 0), l = c, c = n.offsetParent);
    ...
    i.fn.offset = function(n) {
        ...
        var r = this[0],
            u = r && r.ownerDocument;
        return u ? r === u.body ? i.offset.bodyOffset(r) : yi(r, u, u.documentElement) : null
    };
    i.offset = {
    ...
    i.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var n = this.offsetParent || r.body; n && !et.test(n.nodeName) && i.css(n, "position") === "static";) n = n.offsetParent;
                return n
            })
        }
    });
...
jQuery.fn.ensureLoadEvent = function() {
    const n = this;
    jQuery.each(n, function(n, t) {
        t.complete && $(t).load()
    })
};
jQuery.fn.ensureImgLoadEvent = function() {
    function t(n, t, i) {
        var r = new Image;
        r.onload = t;
        r.onerror = i;
