            ...
            return (
              (function () {
                ...
                function u(n) {
                  ...
                  +t > 1
                    ? ($(".popup-pagination").show(),
                      $(".swiper-pagination-full-360").show(),
                      +n == +t
                        ? $("#photo360 .img360-next").addClass("img360-disable")
                        : $("#photo360 .img360-next").removeClass(
                            "img360-disable"
                          ),
                      +n == 1
                        ? $("#photo360 .img360-prev").addClass("img360-disable")
                        : $("#photo360 .img360-prev").removeClass(
                            "img360-disable"
                          ),
                      +n >= 1 &&
                        $(
                          ".swiper-pagination-full-360 .swiper-pagination-current"
                        ).text(n),
                      $(
                        ".swiper-pagination-full-360 .swiper-pagination-total"
                      ).text(t))
                    : ($(".popup-pagination").hide(),
                      $(".swiper-pagination-full-360").hide());
                }
                function s() {
                  if ((t(), $(".slide-3d iframe").attr("src").length <= 0)) {
                    var n = $(
                      ".js__pr-media-slide .js__media-preview li[data-filter=3d]"
                    ).data("src");
                ...
                function h(n) {
                  ...
                  n > 0
                    ? $(
                        "#photo360 .thumbs360 li[data-order=" + n + "]"
                      ).trigger("click")
                    : $(".thumbs360 li.current").length ||
                  ...
                  n >= 0 &&
                    ($(".lg-outer").length > 0
                      ? ($(".lg-item").removeClass("lg-current"),
                        ...
                        $(`.lg-item:nth-child(${n})`).addClass("lg-current"),
                        $(`.lg-thumb-item:nth-child(${n})`).addClass("active"))
                      : p(n));
                ...
                function p(n) {
                  $(
                    `#product-photos .js__product-media:nth-child(${n})`
                  ).click();
                }
                function l() {
                  t();
                ...
                function w() {
                  t();
                  $(".slide-map").show();
                  $(".slide-map iframe").length ||
                    $(".detail-2 .map iframe").clone().appendTo(".slide-map");
                  $(".popup-choice").addClass("popup-choice-map");
                  $(".js__popup-pr-media-slide .icon-close").addClass(
                    "icon-close-black"
                  );
                }
                function t() {
                  $(".js__popup-pr-media-slide .icon-close").removeClass(
                    "icon-close-black"
                  );
                ...
                (function () {
                  navigator.userAgent.match(/iPad/i) !== null
                    ? $("[full-for-ipad]").each((n, t) => {
                        $(t).attr("full", $(t).attr("full-for-ipad")),
                ...
                $(".js__pr-media-slide .pr-img")
                  .on("load", function () {
                    var n = this.width / this.height;
                    n < 1 &&
                      $(this)
                        .parents(".js__media-item-container")
                        .addClass("vertical");
                  })
                  .unbind("error")
                  .on("error", function () {
                ...
                $(".pr-details .video-thumbs-full.swiper-container").css(
                  "max-width",
                  e + "px"
                );
                ...
                n.on("init", function () {
                  ...
                  responsive: [
                    {
                      breakpoint: 1544,
                      settings: { slidesToShow: 6.1, slidesToScroll: 6 },
                    },
                    {
                      breakpoint: 1024,
                      settings: { slidesToShow: 8.5, slidesToScroll: 8 },
                    },
                    {
                      breakpoint: 840,
                      settings: { slidesToShow: 7.1, slidesToScroll: 7 },
                    },
                    {
                      breakpoint: 720,
                      settings: { slidesToShow: 6.1, slidesToScroll: 6 },
                    ...
                    {
                      breakpoint: 640,
                      settings: { slidesToShow: 5.3, slidesToScroll: 5 },
                    },
                  ],
                });
                ...
                i = new Swiper(".js__pr-media-slide .js__media-preview", {
                  ...
                  on: {
                    slideChange: function () {
                      i.realIndex != undefined &&
                        (n.slick("slickGoTo", i.realIndex),
                        n.find(".slick-slide").removeClass("item-thumb-active"),
                        n
                          .find(
                ...
                $(".js__popup-pr-media-slide .icon-close").click(function () {
                  $(".js__tiktok-iframe iframe").attr(
                    "src",
                    $(".js__tiktok-iframe iframe").attr("src")
                  );
                  f();
                  t();
                  $(".swiper-pagination.swiper-pagination-fraction").removeAttr(
                    "style"
                  );
                });
                ...
                $(window).resize(function () {
                  $("#popup-choice li.active").data("filter") + "" == "360" &&
                    $(".thumbs360 li.current").trigger("click");
                  n.slick("setPosition");
                });
                $(window).on("orientationchange", function () {
                  n.slick("setPosition");
                });
                $(".js__pr-media-slide .js__media-preview li").click(
                  function () {
                    var n = $(this).data("filter") + "",
                      t = $(this).data("index"),
                      i;
                    $(".popup-choice li").removeClass("active");
                    $(".popup-choice li[data-filter=" + n + "]").addClass(
                      "active"
                    );
                    ...
                    n === "3d"
                      ? s()
                      : n === "360"
                      ? ((i = $(this).data("order")), h(i))
                      : n === "video"
                      ? l(t)
                      : ($("#product-photos").attr("data-isshow", "true"),
                        c(t));
                  }
                );
                $(".popup-choice li").on("click", function () {
                  ...
                  n === "map"
                    ...
                    ? s()
                    : n === "360"
                    ? (h(), (t = $("#thumbs .current").data("order") + 1), u(t))
                    : n === "video"
                    ? l()
                    : ($("#product-photos").attr("data-isshow", "true"), c(1));
                });
                window.innerWidth < 1024 &&
                  $(".content .slide-image").swipe({
                    swipe: function (n, t) {
                      (t + "" == "up" || t + "" == "down") && f();
                    },
                  });
