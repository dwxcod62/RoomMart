...
FrontEnd.UserListingViewedService = function() {
    ...
    function u(n, t, u, f) {
        ...
        return !u && !f ? {
            ...
            productViews: [{
                productId: t,
                expiredDate: s.toISOString()
            }]
        } : (e = [], !!u && !!u.productViews && u.productViews.length > 0 && u.productViews.forEach(function(n) {
            Date.parse(n.expiredDate) > h && e.push(n)
        }), !!f && !!f.productViews && f.productViews.length > 0 && f.productViews.forEach(function(n) {
            Date.parse(n.expiredDate) > h && e.push(n)
        }), o = [], e.forEach(function(n) {
            o.push(n.productId)
        }), t > 0 && !o.includes(t) ? e.push({
            productId: t,
            expiredDate: s.toISOString()
        }) : t > 0 && !!o.includes(t) && e.forEach(function(n) {
