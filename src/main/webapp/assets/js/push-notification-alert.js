    ...
    if (mainNoti) {
        ...
        var n1 = `
            <div class="push-noti__wrapper">
              <h5 class="push-noti__title">${message != null ? 'Tin nhắn mới' : 'Thông báo mới'}</h5>
        ...
        var n2= `
            ...
            <div class="push-noti__wrapper">
              ...
              <div style="overflow: hidden" class="push-noti__body">
<!--               href="roomDetail?hostelId=${hid}&rid=${rid}" -->

              <a href="roomDetail?hostelId=${hid}&rid=${rid}" style="text-decoration: none; color: inherit;">Đến phòng</a>
                <p style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden" class="push-noti__msg">${notify}</p>
